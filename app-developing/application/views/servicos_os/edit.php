    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Servicos Os Edit</h3>
            </div>
			<?php echo form_open('servicos_os/edit/'.$servicos_os['id_servicos_os']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="os_id" class="form-control">
								...
								{
									$selected = ($os['id_os'] == $servicos_os['os_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="servicos_id" class="form-control">
								...
								{
									$selected = ($servico['id_servicos'] == $servicos_os['servicos_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="sub_total_servico_os" value="<?php echo ($this->input->post('sub_total_servico_os') ? $this->input->post('sub_total_servico_os') : $servicos_os['sub_total_servico_os']); ?>" class="form-control" id="sub_total_servico_os" />
						</div>
					</div>
				</div>
			</div>
