<?php echo form_open('enderecos_cliente/edit/'.$enderecos_cliente['id_endereco_cliente'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="endereco_id_cliente" class="form-control">
				...
				{
					$selected = ($cliente['id_cliente'] == $enderecos_cliente['endereco_id_cliente']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="cliente_id_endereco" class="form-control">
				<option value="">select endereco</option>
				<?php 
				foreach($all_enderecos as $endereco)
				{
					$selected = ($endereco['id_endereco'] == $enderecos_cliente['cliente_id_endereco']) ? ' selected="selected"' : "";
