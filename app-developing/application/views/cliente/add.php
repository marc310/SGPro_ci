          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nome_cliente" value="<?php echo $this->input->post('nome_cliente'); ?>" class="form-control" id="nome_cliente" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tipo_pessoa" value="<?php echo $this->input->post('tipo_pessoa'); ?>" class="form-control" id="tipo_pessoa" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="documento" class="control-label">Documento</label>
						<div class="form-group">
							<input type="text" name="documento" value="<?php echo $this->input->post('documento'); ?>" class="form-control" id="documento" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="data_cadastro_cliente" value="<?php echo $this->input->post('data_cadastro_cliente'); ?>" class="form-control" id="data_cadastro_cliente" />
						</div>
					</div>
				</div>
			</div>
