    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Producao Os Add</h3>
            </div>
            <?php echo form_open('producao_os/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="material_id" class="form-control">
								...
								{
									$selected = ($material['id_material'] == $this->input->post('material_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="unidade_medida_id" class="form-control">
								...
								{
									$selected = ($unidades_medida['id_unidade_medida'] == $this->input->post('unidade_medida_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="acabamento_id" class="form-control">
								...
								{
									$selected = ($acabamento['id_acabamento'] == $this->input->post('acabamento_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="descricao_producao" value="<?php echo $this->input->post('descricao_producao'); ?>" class="form-control" id="descricao_producao" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tipo_producao" class="control-label">Tipo Producao</label>
						<div class="form-group">
							<input type="text" name="tipo_producao" value="<?php echo $this->input->post('tipo_producao'); ?>" class="form-control" id="tipo_producao" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="medida_producao" class="control-label">Medida Producao</label>
						<div class="form-group">
							<input type="text" name="medida_producao" value="<?php echo $this->input->post('medida_producao'); ?>" class="form-control" id="medida_producao" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="quantidade_producao" class="control-label"><span class="text-danger">*</span>Quantidade Producao</label>
						<div class="form-group">
							<input type="text" name="quantidade_producao" value="<?php echo $this->input->post('quantidade_producao'); ?>" class="form-control" id="quantidade_producao" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="status_producao" value="<?php echo $this->input->post('status_producao'); ?>" class="form-control" id="status_producao" />
						</div>
					</div>
				</div>
			</div>
