          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tipo_os" value="<?php echo $this->input->post('tipo_os'); ?>" class="form-control" id="tipo_os" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="data_inicio" class="control-label"><span class="text-danger">*</span>Data Inicio</label>
						<div class="form-group">
							<input type="text" name="data_inicio" value="<?php echo $this->input->post('data_inicio'); ?>" class="form-control" id="data_inicio" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="data_final" value="<?php echo $this->input->post('data_final'); ?>" class="form-control" id="data_final" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="status_os" class="control-label">Status Os</label>
						<div class="form-group">
							<input type="text" name="status_os" value="<?php echo $this->input->post('status_os'); ?>" class="form-control" id="status_os" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="os_faturada" value="<?php echo $this->input->post('os_faturada'); ?>" class="form-control" id="os_faturada" />
						</div>
					</div>
					<div class="col-md-6">
