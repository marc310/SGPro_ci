...
class Enderecos_cliente_model extends CI_Model
{
     ...
     */
    // function get_EnderecosPeloId_cliente($IDCliente)
    // {
    //
    //     $this->db->order_by('id_endereco_cliente', 'desc');
    //     $this->db->where('cliente_id', $IDCliente);
    //     $this->db->join('enderecos','enderecos_cliente.id_endereco_cliente = enderecos.id_endereco');
     ...
     * Get all enderecos_cliente
     */
    function get_all_enderecos_cliente()
    {
        $this->db->order_by('id_endereco_cliente', 'desc');
        return $this->db->get('enderecos_cliente')->result_array();
    }
